...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------- | ------ |
| **Home**              | Dashboard: greeting, due-today / overdue stats, a "due today" + "coming up" task list, project links                        | ✅     |
| **Projects**          | Create projects, recolor them, favorite them (list or board header), add a multi-line description, archive/delete           | ✅     |
...
| **My Tasks**          | Open tasks across projects — quick-add, group (due/priority/focus/project/label), sort + collapse, filter assigned/followed | ✅     |
...
| **Filter & sort**     | Hide/show completed, filter by label / priority / due / assignee / custom field, sort; a "Clear filters (N)" reset          | ✅     |
